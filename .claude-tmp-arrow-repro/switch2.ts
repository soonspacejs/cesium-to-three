...
const cp4:LonLatPoint[]=[[cLon-45*mLon,cLat-30*mLat],[cLon-45*mLon,cLat+30*mLat],[cLon,cLat+50*mLat],[cLon+75*mLon,cLat+10*mLat]];
const cells:[string,LonLatPoint[]][]=[
  ['attack 4pt',createAttackArrow(cp4)],
  ['swallow 4pt',createSwallowtailAttackArrow(cp4)],
...
const im=img0();const cols:[number,number,number][]=[[200,70,50],[150,60,210],[200,70,50],[150,60,210]];
...
writeFileSync('.claude-tmp-arrow-repro/png-switch.png',enc(im));console.log('wrote png-switch.png (TL attack4 TR swallow4 BL U->attack BR U->swallow)');
